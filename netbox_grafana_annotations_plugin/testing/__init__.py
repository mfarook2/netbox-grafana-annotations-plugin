"""
Standalone testing base classes for NetBox Grafana Annotations Plugin.
    ...
    def add_permissions(self, *permissions: str):
        ...
        Args:
            *permissions: Permission names in format "app.action_model"
                         e.g., "netbox_grafana_annotations_plugin.add_grafanaannotations"

        Example:
            self.add_permissions(
                "netbox_grafana_annotations_plugin.view_grafanaannotations",
                "netbox_grafana_annotations_plugin.add_grafanaannotations",
            )
        """
...
class PluginViewTestCase(PluginModelTestCase):
    ...
    def _get_base_url(self) -> str:
        ...
        Returns:
            Base URL string (e.g., "plugins:netbox_grafana_annotations_plugin:grafanaannotations")
        """
