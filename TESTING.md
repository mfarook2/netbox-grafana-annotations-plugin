# Testing Guide for NetBox Grafana Annotations Plugin

This guide explains how to write and run tests for NetBox Grafana Annotations Plugin.

## Test Structure

Tests are organized in the `netbox_grafana_annotations_plugin/tests/` directory:
...
```python
from netbox_grafana_annotations_plugin.testing import PluginTestCase

class MyTestCase(PluginTestCase):
    def test_something(self):
        # self.user is automatically created
        # self.client is logged in
        self.add_permissions('netbox_grafana_annotations_plugin.view_grafanaannotations')
        # ... test code ...
```
...
```python
from netbox_grafana_annotations_plugin.testing import PluginModelTestCase
...
```python
from netbox_grafana_annotations_plugin.testing import PluginAPITestCase

class MyAPITestCase(PluginAPITestCase):
    def setUp(self):
        super().setUp()
        self.list_url_name = 'plugins-api:netbox_grafana_annotations_plugin-api:mymodel-list'
        self.detail_url_name = 'plugins-api:netbox_grafana_annotations_plugin-api:mymodel-detail'
...
```python
from netbox_grafana_annotations_plugin.testing import PluginViewTestCase

class MyViewTestCase(PluginViewTestCase):
    def setUp(self):
        super().setUp()
        self.base_url = 'plugins:netbox_grafana_annotations_plugin:mymodel'
...
```python
from netbox_grafana_annotations_plugin.testing import PluginGraphQLTestCase
...
The `netbox_grafana_annotations_plugin.testing.utils` module provides helpful utilities:

```python
from netbox_grafana_annotations_plugin.testing.utils import (
...
user = create_test_user(permissions=['netbox_grafana_annotations_plugin.view_grafanaannotations'])
...
python manage.py test netbox_grafana_annotations_plugin.tests.test_models

# Run specific test class
python manage.py test netbox_grafana_annotations_plugin.tests.test_models.GrafanaannotationsTestCase

# Run specific test method
python manage.py test netbox_grafana_annotations_plugin.tests.test_models.GrafanaannotationsTestCase.test_create

# Run with verbose output
python manage.py test netbox_grafana_annotations_plugin.tests -v 2

# Run in parallel (faster)
python manage.py test netbox_grafana_annotations_plugin.tests --parallel

# Keep database between runs (faster during development)
python manage.py test netbox_grafana_annotations_plugin.tests --keepdb
```
...
# Run tests
docker-compose exec netbox python manage.py test netbox_grafana_annotations_plugin.tests

# Run specific tests
docker-compose exec netbox python manage.py test netbox_grafana_annotations_plugin.tests.test_api
...
def test_form_validation(self):
    ...
    url = reverse('netbox_grafana_annotations_plugin:mymodel_add')
...
**"No module named 'netbox_grafana_annotations_plugin'"**
